...
<div id="admin-update-place-form" class="admin-form-container" data-place-id="{{ $placeId ?? 'null' }}">
    <h2 class="admin-form-title"><i class="bi bi-geo-alt-fill"></i>Изменить место</h2>
        ...
        <div class="form-control-group">
            ...
            <div class="file-upload-container">
                ...
                <label class="file-upload-btn" for="place-image-input">
                    <i class="bi bi-upload"></i>Изменить изображение
                </label>
    ...
    <div class="form-buttons-group">
        <button type="button" class="admin-form-button" id="update-place-btn">
            <i class="bi bi-save"></i>Обновить место
        </button>
