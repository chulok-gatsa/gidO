...
<div id="admin-update-news-form" data-news-id="{{ $newsId ?? 'null' }}" class="admin-form-container">
    <h2 class="admin-form-title"><i class="bi bi-newspaper"></i>Изменить новость</h2>
    ...
    <div class="form-buttons-group">
        <button type="button" class="admin-form-button" id="update-news-btn">
            <i class="bi bi-save"></i>Обновить новость
        </button>
